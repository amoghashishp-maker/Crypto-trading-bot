...
This is an network designed to automate cryptocurrency trading using python. Uses the CCXT Library to connect securely to Public API's, takes in real-time market metrics and uses numbpy and pandas to vector map the relationship. This model has been changed from the standard 10-30 windows to 5-20 and is therefore optimized for more variability.
